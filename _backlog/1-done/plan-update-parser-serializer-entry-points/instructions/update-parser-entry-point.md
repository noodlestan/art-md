...
- Design attachment (authoritative source code + file locations): `$PROJECT/_roadmap/1-done/milestone-art-codec/milestone__design.md` — read `## Entry Point Changes` (parser entry point) and `### createDocumentVisitContext()`.
