...
- Design attachment (authoritative source code + file locations): `$PROJECT/_roadmap/1-done/milestone-art-codec/milestone__design.md` — read `## Contracts` → `### ArtContentSource`, `### ArtDocumentSource`, and `### createArtDocumentSource()`.
